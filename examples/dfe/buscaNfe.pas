...
var
  Resp: string;
  JsonResp, DocItem, EventoItem: TJSONObject;
  ...
  try
    ...
    try
      ...
      try
        ...
        Resp := IntegraDfe.BuscaNfe(Payload);
        ...
        try
          ...
          begin
            ...
            if Assigned(EventosArray) then
              ...
              begin
                EventoItem := EventosArray.Items[I] as TJSONObject;
                Chave := TIntegraUtil.GetValueFromJson(EventoItem, 'chave');
                ShowMessage('Evento chave: ' + Chave);
              end;
          end
          else
