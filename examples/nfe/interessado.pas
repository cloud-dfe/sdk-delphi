  ...
  try
    ...
    try
      ...
      try
        ...
        Payload.AddPair('tipo_autor', '1');
        Payload.AddPair('permite', 'true');
        Payload.AddPair('numero_evento', TJSONNumber.Create(1));
        Payload.AddPair('cpf', '01234567890');

        Resp := IntegraNfe.Interessado(Payload);
