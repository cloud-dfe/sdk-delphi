...
begin
  ...
  try
    ...
    try
      Payload.AddPair('chave', '50000000000000000000000000000000000000000000'); // Chave de acesso obrigatória
      Payload.AddPair('cancela', TJSONTrue.Create); // Indicador de cancelamento
