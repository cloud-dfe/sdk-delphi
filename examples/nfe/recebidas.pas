...
begin
  ...
  try
    ...
    try
      ...
      try
        Payload.AddPair('ultimo_nsu', '0');
        Payload.AddPair('numero_nsu', TJSONNull.Create);
        Payload.AddPair('eventos', TJSONBool.Create(False));

        Resp := IntegraNfe.Recebidas(Payload);
