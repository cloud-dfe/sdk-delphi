  ...
  try
    ...
    try
      ...
      try
        ...
        Payload.AddPair('codigo_municipio_carregamento', '2408003');
        Payload.AddPair('nome_municipio_carregamento', 'Mossoró');
        Payload.AddPair('codigo_municipio_descarregamento', '5200050');
        Payload.AddPair('nome_municipio_descarregamento', 'Abadia de Goiás');
        Payload.AddPair('chave_nfe', '50000000000000000000000000000000000000000001');

        Resp := IntegraMdfe.Nfe(Payload);
