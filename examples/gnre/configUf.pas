...
begin
  ...
  try
    ...
    try
      ...
      try
        Payload.AddPair('uf_favorecida', 'RR');
        Payload.AddPair('codigo_receita', TJSONNull.Create);
        Payload.AddPair('curier', TJSONNull.Create);

        Resp := IntegraGnre.ConfigUf(Payload);
